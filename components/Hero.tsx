  ...
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center pt-20 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="inline-flex items-center space-x-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-white/5 border border-white/10 mb-6 md:mb-8 backdrop-blur-sm animate-fade-in">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-7xl font-extrabold tracking-tight mb-6 md:mb-8 leading-tight animate-slide-up-lg">
        ...
        <p className="max-w-2xl mx-auto text-base md:text-xl text-slate-400 mb-8 md:mb-12 leading-relaxed px-4 md:px-0 animate-fade-in" style={{ animationDelay: '200ms' }}>
          {t.hero.subtitle}
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 px-4 sm:px-0 animate-fade-in" style={{ animationDelay: '400ms' }}>
          <a 
            href="#contact"
        ...
        <div className="mt-16 md:mt-24 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 opacity-60 md:opacity-50 transition-all duration-500 max-w-4xl mx-auto px-4 animate-fade-in" style={{ animationDelay: '600ms' }}>
